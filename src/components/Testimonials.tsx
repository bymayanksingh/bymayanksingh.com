            ...
            testimonials.items.map((testimonial, index) => (
              ...
              >
                ...
                <div className="bg-gray-800 px-4 py-3 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-gray-400 text-xs font-mono">+{testimonial.rating}% / -0%</span>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="ml-3">
                      <div className="text-gray-100 font-mono font-semibold">{testimonial.author}</div>
                      <div className="text-gray-400 text-sm font-mono">{testimonial.position}</div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-700">
                    <div className="flex items-center justify-between text-xs font-mono">
                      <span className="text-gray-400">Merged by {testimonial.company}</span>
                      <div className="flex items-center space-x-2">
